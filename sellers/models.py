...
class Contacts(models.Model):
    ...
    street = models.CharField(max_length=50, verbose_name="Улица", help_text="Укажите улицу")
    house_number = models.CharField(max_length=50, verbose_name="Номер дома", help_text="Укажите номер дома")
...
class Seller(models.Model):
    ...
    contacts = models.OneToOneField(Contacts, on_delete=models.SET_NULL,
                                    verbose_name="Контакты",
                                    help_text="Укажите контакты",
                                    related_name="contacts",
                                    **NULLABLE)
    products = models.ManyToManyField(Product, on_delete=models.SET_NULL, verbose_name="Контакты",
                                      help_text="Укажите продукты",
                                      related_name="products",
                                      **NULLABLE)
    supplier = models.OneToOneField("self", on_delete=models.SET_NULL,
    ...
    trade_network_level = models.PositiveIntegerField(choices=TRADE_NETWORK_LEVEL_CHOICES,
                                                       verbose_name="Уровень в торговой сети",
                                                       help_text="Укажите уровень в торговой сети")
    seller_type = models.CharField(max_length=30, choices=SELLER_TYPE_CHOICES, verbose_name="Тип продавца",
